...
final class HealthjournalController extends AbstractController
{
    ...
    public function index(HealthjournalRepository $healthjournalRepository, Request $request, Security $security): Response
    {
        ...
        $queryBuilder->andWhere('h.user = :user')
    ...
    public function search(HealthjournalRepository $healthjournalRepository, Request $request, Security $security): JsonResponse
    {
        $user = $security->getUser();
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, HealthjournalRepository $healthjournalRepository, Security $security): Response
    {
