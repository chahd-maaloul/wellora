...
class HealthPredictionService
{
     ...
     * Uses all available entries regardless of journal for prediction.
     * 
     ...
     */
    public function predictGlycemia(?Healthjournal $journal = null): HealthPredictionDTO
    {
        ...
        try {
            // Fetch ALL historical entries (not limited by journal)
            $entries = $this->getAllHistoricalEntries();
    ...
    /**
     * Fetch all historical health entries (not limited by journal).
     *
     * @return array<int, Healthentry>
     */
    private function getAllHistoricalEntries(): array
    {
