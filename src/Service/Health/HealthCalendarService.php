...
final class HealthCalendarService
{
     ...
     * @throws \InvalidArgumentException If journal not found or access denied
     */
    public function getEventsForJournal(int $journalId, ?User $user = null): array
    {
        ...
        if ($user && $journal->getUser() !== $user) {
            throw new \InvalidArgumentException('Access denied to this journal');
        }

        // Get entries for this specific journal
