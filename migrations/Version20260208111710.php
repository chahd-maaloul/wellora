 ...
 */
final class Version20260208111710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication_parcours (id INT AUTO_INCREMENT NOT NULL, image_publication VARCHAR(255) NOT NULL, ambiance INT NOT NULL, securite INT NOT NULL, date_publication DATE NOT NULL, parcours_de_sante_id INT DEFAULT NULL, INDEX IDX_B6D62BB28E7843E8 (parcours_de_sante_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
